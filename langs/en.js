const LANG_EN = {
    ...
    matching_hint:
        'Pick a cached POI layer and a point. Yes keeps the same-nearest area; No keeps the rest.',
    btn_add_matching: '+ Add matching question',
    btn_clear_matching: 'Remove all matching',
    matching_layer: 'Layer',
    matching_choose_layer: 'Choose a POI layer',
    matching_pick: 'Click to select location',
    matching_need_layer: 'Choose a POI layer first.',
    matching_need_point: 'Choose a layer and a matching point first.',
    matching_no_layers: 'No cached POI layers available yet. Finish map setup first.',
    ...
    matching_card_title: 'Matching Q{0}',
    ...
    sec_rq: 'Radar',
    rq_hint:
        'Place a radar at a point, set its radius, then answer yes/no. A yes keeps the area inside the radar, a no blocks out that radar zone from the final map.',
    btn_add_rq: '+ Add radar',
    btn_clear_rq: 'Remove all radar',
    ...
    status_rq_pick: 'Click on the map to set the radar centre',
